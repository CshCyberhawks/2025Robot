...
class PivotIOPID() : PivotIO {
    ...
    val pivotPIDController =
        ProfiledPIDController(
            ...
            0.0,
            0.0,
            TrapezoidProfile.Constraints(PivotConstants.velocityDegrees, PivotConstants.accelerationDegrees)
        )
...
//        motor.setPosition((currentPosition - 45.0))
    ...
    override fun atDesiredAngle(): Boolean =
        MiscCalculations.appxEqual(getAngle(), desiredAngle, PivotConstants.angleToleranceDegrees)
...
//        )
    ...
    override fun periodic() {
        ...
        SmartDashboard.putNumber("Pivot Position Elevator", pivotPIDController.positionError)
